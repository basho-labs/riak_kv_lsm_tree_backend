...
%%%
%%% This is a temporary copy of riak_kv_backend, just here to keep lsm_tree
%%% development private for now. When riak_kv_lsm_tree_backend is moved to
%%% riak_kv, delete this file.
%%%
%%% NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE NOTE


-module(lsm_tree_temp_riak_kv_backend).
